...
class Auth
{
    ...
    protected $_token = '';
    protected $keeptime = 2592000;    //Token默认有效时长
    protected $requestUri = '';
    protected $rules = [];
    //默认配置
    protected $config = [];
    protected $options = [];
    protected $allowFields = ['id','username', 'nickname', 'mobile', 'avatar', 'score','bio','money','level','status','isvip','expiretime'];
    ...
    {
        $field = \think\facade\Validate::is($account, 'email') ? 'email' : (\think\facade\Validate::regex($account,
